...
const PRESENTATIONS: Record<string, StatusPresentation> = {
  ...
  processing: { label: "处理中", tone: "processing", icon: Loader2, spinning: true },
  review_ready: { label: "待复核", tone: "info", icon: CheckCircle2 },
  publishing: { label: "发布中", tone: "processing", icon: Loader2, spinning: true },
  completed: { label: "已完成", tone: "success", icon: CheckCircle2 },
  partial_failed: { label: "部分失败", tone: "warning", icon: AlertCircle },
  uploaded: { label: "已上传", tone: "info", icon: CheckCircle2 },
  normalizing: { label: "整理中", tone: "processing", icon: Loader2, spinning: true },
  asr_running: { label: "识别中", tone: "processing", icon: Loader2, spinning: true },
  copy_running: { label: "文案中", tone: "processing", icon: Loader2, spinning: true },
  cover_running: { label: "封面中", tone: "processing", icon: Loader2, spinning: true },
  manual_review_ready: { label: "待人工发布", tone: "info", icon: CheckCircle2 },
  generation_failed: { label: "生成失败", tone: "error", icon: AlertCircle },
  publish_failed: { label: "发布失败", tone: "error", icon: AlertCircle },
  excluded: { label: "已跳过", tone: "muted", icon: PauseCircle },
  scheduled: { label: "已定时", tone: "warning", icon: Clock },
