...
## 测试
- `pytest tests/api`(conftest 默认置 `CUTAGENT_ALLOW_SANDBOX_FALLBACK=1`)；上传/对象存储重点见 `test_upload_direct_flow.py`、`test_upload_object_store.py`、`test_object_store_presign.py`。
