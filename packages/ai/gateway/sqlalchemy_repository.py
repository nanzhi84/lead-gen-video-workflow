...
def provider_capability_row_to_contract(row: ProviderCapabilityRow) -> ProviderCapability:
    return ProviderCapability(
        ...
        input_schema_ref=ProviderOptionsSchemaRef.model_validate(row.input_schema_ref),
        output_schema_ref=ProviderOptionsSchemaRef.model_validate(row.output_schema_ref),
        schema_version=row.schema_version,
        created_at=row.created_at,
        updated_at=row.updated_at,
    )
